    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.containerLeft}>
        ...
        <View style={styles.containerLeftTop}>
            ...
            <View>
                <Text style={styles.containerLeftTopText}>Welcome, FarmerName! </Text>
            </View>

        </View>

        <View>
            <Text style={styles.containerLeftBottomText}>Here is your farm's summary.</Text>
        </View>

      </View>

        <TouchableOpacity onPress={() => router.push("/farmer/my-account")}>
